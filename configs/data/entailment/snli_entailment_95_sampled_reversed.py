...
train = {
    ...
    "source_dataset": {
        "files": os.path.join(base_path, "../threshold/train.sources.0.95.sampled.50000.reversed"),
        "vocab_file": source_vocab_file,
    },
    "target_dataset": {
        "files": os.path.join(base_path, "../threshold/train.targets.0.95.sampled.50000.reversed"),
